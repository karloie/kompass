...
var ResourceTypes = func() map[string]ResourceType {
	m := map[string]ResourceType{
		...
		"ciliumclusterwidenetworkpolicy": {"🕸️", kube.LoadCiliumClusterwideNetworkPolicy, inferCiliumClusterwideNetworkPolicy, []string{"pod"}},
		...
		"configmaps":              {"⚙️", nil, nil, nil},
		"cronjob":                 {"📆", kube.GetLoader("cronjob"), inferWorkload("cronjob"), []string{"job"}},
		"csidriver":               {"🔩", kube.GetLoader("csidriver"), inferCSIDriver, []string{"csinode"}},
		"csinode":                 {"💻", kube.GetLoader("csinode"), inferCSINode, nil},
		"daemonset":               {"🛰️", kube.GetLoader("daemonset"), inferWorkload("daemonset"), nil},
		...
		"gateway":                 {"⛩️", kube.LoadGateway, inferGateway, nil},
		...
		"secretproviderclass": {"🔏", kube.LoadSecretProviderClass, inferSimpleNode("secretproviderclass"), []string{"secret"}},
		"service":             {"🤝", kube.LoadService, inferService, []string{"pod"}},
		"serviceaccount":      {"👤", kube.GetLoader("serviceaccount"), inferServiceAccount, []string{"pod"}},
		"statefulset":         {"🗄️", kube.GetLoader("statefulset"), inferWorkload("statefulset"), []string{"persistentvolumeclaim"}},
		"storageclass":        {"🗂️", kube.GetLoader("storageclass"), inferStorageClass, []string{"persistentvolume"}},
		...
		"ccwnp-egress":               {"👈", nil, nil, []string{"service"}},
		"ccwnp-ingress":              {"👉", nil, nil, nil},
